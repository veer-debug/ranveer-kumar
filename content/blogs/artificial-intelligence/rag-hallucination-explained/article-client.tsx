...
interface RagHallucinationArticleClientProps {
  html: string
}

const POST_ID = getPostId("artificial-intelligence", "rag-hallucination-explained")

export default function RagHallucinationArticleClient({ html }: RagHallucinationArticleClientProps) {
  useEffect(() => {
    const onScroll = () => {
